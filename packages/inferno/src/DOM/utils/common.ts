...
export function splitProps(lastProps: any, nextProps: any, customElement /* InfernoCustomElement */): [Record<string, any>, Record<string, any>, Record<string, any>] {
  if (isUndefined(customElement)) {
    return [lastProps, nextProps, EMPTY_OBJ];
  }
  ...
  return [_lastProps ?? EMPTY_OBJ, _nextProps ?? EMPTY_OBJ, _nextCustomElementProps ?? EMPTY_OBJ];
}
